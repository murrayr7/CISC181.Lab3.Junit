...
public class TestHands {
	...
	public final void TestFlush1() {
		...
		assertEquals("Should be Sf:",eHandStrength.Flush.getHandStrength(),h.getHandStrength());		
	}
	...
	public final void TestStraight1() {
		...
		assertEquals("Should be Sf:",eHandStrength.Straight.getHandStrength(),h.getHandStrength());		
	}
	...
	public final void TestTwoPair1() {
		...
		assertEquals("Should be Sf:",eHandStrength.TwoPair.getHandStrength(),h.getHandStrength());		
	}
	...
	public final void TestPair1() {
		...
		assertEquals("Should be Sf:",eHandStrength.Pair.getHandStrength(),h.getHandStrength());		
	}
	...
	public final void TestHighCard1() {
		...
		assertEquals("Should be Sf:",eHandStrength.HighCard.getHandStrength(),h.getHandStrength());		
	}
